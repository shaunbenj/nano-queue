...
describe("SkipList", () => {
  ...
  it("exists", () => {
    ...
    assert.strictEqual(skipList.exists("2"), true);
    assert.strictEqual(skipList.exists("4"), false);
    assert.strictEqual(skipList.exists(""), false);
  });
  ...
  it("gets by range score", () => {
    ...
    assert.deepStrictEqual(skipList.getByRange("0", "2"), ["1", "2"]);
    assert.deepStrictEqual(skipList.getByRange("0", "9"), ["1", "2", "3"]);
  });
  ...
  it("deletes by score range", () => {
    ...
    let deleted = skipList.deleteByRange("0", "0");
    ...
    deleted = skipList.deleteByRange("0", "10");
